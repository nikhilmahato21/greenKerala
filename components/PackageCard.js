    ...
    >
      ...
      >
        ...
        <div style={{ padding: '18px 20px 20px', flex: 1, display: 'flex', flexDirection: 'column' }}>
          ...
          {/* Title */}
          <h3 style={{ fontWeight: 700, fontSize: 17, color: '#111827', marginBottom: 4, lineHeight: 1.3 }}>
            {pkg.title}
          </h3>
          ...
          <div
            style={{
              ...
              borderRadius: 999, fontSize: 11, color: '#6b7280',
...
"
          ...
          <button
            style={{
              ...
              borderRadius: 999, fontWeight: 600, fontSize: 14, color: '#fff',
